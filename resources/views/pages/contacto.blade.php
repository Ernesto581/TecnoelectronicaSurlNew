...
<div class="flex flex-col bg-gray-50 min-h-screen">
    ...
    {{-- HERO SECTION --}}
    <section class="relative overflow-hidden pt-36 pb-56">
        <!-- Imagen de fondo -->
        <img 
            src="https://picsum.photos/seed/contacto/1920/600" 
            class="absolute inset-0 w-full h-full object-cover"
            alt="Contacto Tecnoelectronica">

        <!-- Capas de degradado y color -->
        <div class="absolute inset-0 bg-gradient-to-r from-gray-950/95 via-gray-900/90 to-gray-900/70"></div>
        <div class="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(70,160,64,.25),transparent_50%)]"></div>
        ...
        <div class="relative z-10 max-w-[1400px] mx-auto px-4 md:px-8 text-center">
            ...
            <h1 class="text-4xl md:text-6xl lg:text-7xl font-display font-bold text-white tracking-tight leading-tight mb-6">
    ...
    {{-- CONTENEDOR FLOTANTE (Información + Formulario) --}}
    <section class="relative z-20 max-w-[1400px] mx-auto px-4 md:px-8 -mt-32 mb-24">
        <div class="grid lg:grid-cols-12 gap-8 items-start">
            ...
            <div class="lg:col-span-5 space-y-5">
                ...
                <!-- WhatsApps (Combinados en una tarjeta) -->
                <div class="group bg-white rounded-3xl p-7 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 hover:shadow-xl hover:border-[#46A040]/30 transition-all duration-300 flex items-start gap-5">
                    <div class="w-14 h-14 rounded-2xl bg-[#ecf8ef] flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform duration-300">
                    ...
                    <div class="w-full">
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center justify-between bg-gray-50 p-3 rounded-xl border border-gray-100">
                                ...
                                <x-icon name="headphones" class="w-5 h-5 text-gray-300" />
                            </div>
                            ...
                            <div class="flex items-center justify-between bg-gray-50 p-3 rounded-xl border border-gray-100">
                                ...
                                <x-icon name="tool" class="w-5 h-5 text-gray-300" />
                            </div>
                        </div>
                    </div>
                </div>
    ...
    {{-- MAPA FULL WIDTH --}}
    <section class="max-w-[1400px] mx-auto px-4 md:px-8 pb-32">
        ...
        <div class="relative rounded-[32px] overflow-hidden shadow-2xl border border-gray-200 h-[500px] bg-gray-100 group">
            <!-- Capa de interacción (para que no haga zoom accidental al scrollear, opcional) -->
            <div class="absolute inset-0 bg-transparent z-10 pointer-events-none"></div>
            
            <iframe 
                src="https://www.openstreetmap.org/export/embed.html?bbox=-79.975%2C22.395%2C-79.955%2C22.415&amp;layer=transport&amp;marker=22.4064%2C-79.9647" 
                class="w-full h-full grayscale-[0.2] contrast-125 group-hover:grayscale-0 transition-all duration-700" 
                style="border:0;" 
                allowfullscreen 
                loading="lazy">
            </iframe>
