...
<div class="min-h-screen flex items-center justify-center bg-gray-50 px-4 pt-28">
    <div class="text-center max-w-lg">
        <div class="w-20 h-20 rounded-2xl bg-[#46A040]/10 flex items-center justify-center mx-auto mb-6">
            <x-icon name="search" class="w-10 h-10 text-[#46A040]" />
        </div>
        <h1 class="text-6xl font-black text-gray-900 mb-4">404</h1>
        <p class="text-xl font-semibold text-gray-900 mb-2">Página no encontrada</p>
